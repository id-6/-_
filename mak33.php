...
$botgetMe = json_decode(file_get_contents("https://api.telegram.org/bot".$token."/getMe"));
$BotUserName = $botgetMe->result->username;
$chatt = " تم انشاء الويب هوك لبوتك بنجاح بواسطه هذا البوت :  @$BotUserName 
ــــــــــــــ❍ــــــــــــــ
$weeee
";
$chatt2 = " تم جلب معلومات التوكن لبوتك بنجاح بواسطه هذا البوت :  @$BotUserName ";
$chatt3 = " تم حذف الويب هوك لبوتك بنجاح بواسطه هذا البوت :  @$BotUserName ";
$weeee = file_get_contents("we_$chat_id.json");
...
elseif($ali == "url"){
$jackkk1 = file_get_contents($text);
$jackkk2 =  strip_tags($jackkk1);
if (!preg_match("/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i",$text))
 ...
 file_put_contents("data/$from_id/url.txt",$text);
  ...
  file_put_contents("we_$chat_id.json",$jackkk2);
  file_get_contents("http://api.telegram.org/bot$to/sendmessage?chat_id=$from_id&text=$jackkk2");
  sleep(1);
   	bot('editmessagetext',[
    'chat_id'=>$chat_id,
...
لو هناك خطأ بالملف سيظهر بالاسفل 👇
ـــــــــــــــــــ❍ـــــــــــــــــــ
$jackkk2
",
  ]);
...
if($to != "no"){
  ...
  file_get_contents("http://api.telegram.org/bot$to/sendmessage?chat_id=$from_id&text=$chatt");
  sleep(1);
  file_put_contents("data/$from_id/ali_rahim","no");
	bot('sendmessage',[
	'chat_id'=>$chat_id,
...
file_get_contents("http://api.telegram.org/bot$to/sendmessage?chat_id=$from_id&text=$chatt2");
sleep(1);
	bot('sendmessage',[
	'chat_id'=>$chat_id,
		    'message_id'=>$message_id + 1,
	'text'=>"تـم جـلـب ️ مـعـلـومـات الـتـوكـن بـنـجـاح ℹ️",
        'parse_mode'=>'MarkDown',
        	'reply_markup'=>json_encode([
	'resize_keyboard'=>true,
	'keyboard'=>[
...
sleep(1);
  ...
  file_get_contents("http://api.telegram.org/bot$to/sendmessage?chat_id=$from_id&text=$chatt3");
  sleep(1);
  file_put_contents("data/$from_id/ali_rahim","no");
	bot('sendmessage',[
	'chat_id'=>$chat_id,
